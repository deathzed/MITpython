...
pic_choice = raw_input( 'Please choose a picture, you can enter a url: ')

def pic_get(pic_choice):
	import json
	import requests
	payload = {'date':'2016-05-17','key':'d39de78b6bbe7aa8fcc3b2b3a2171b4a95171e85'}
	try:
		r = requests.get("https://gateway-a.watsonplatform.net/visual-recognition/api/v3/classify?api_key=d39de78b6bbe7aa8fcc3b2b3a2171b4a95171e85&url=" + pic_choice + "&version=2016-05-17'.", params=payload)
	except:
...
resultstr = str(pic_get(pic_choice))
